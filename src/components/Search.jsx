...
export default function Search({ filteredImages, setLoading, searchKey }) {
  ...
  return (
      <div className="absolute sm:top-[150px] top-[80px] left-0 w-full bg-black rounded-xl py-10 z-[99]">
          <AiOutlineCloseSquare className="absolute top-5 right-8 text-6xl text-white w-fit" onClick={setLoading} />
          ...
          <h3 className="text-sm text-center italic text-pink-400 font-bold py-5 underline">close when done</h3>
